    ...
    return (
        <footer className="bg-gray-100 dark:bg-gray-800 py-10 px-6 md:px-12 lg:px-24">
            <div className='flex flex-row items-center justify-center mb-6 gap-4'>
                ...
                </a><a href="https://github.com/RudyG93" target="_blank" className="inline-flex items-center justify-center w-10 h-10 rounded-full" aria-label="Aller sur Github">
            ...
            <p className='text-white text-center max-w-3xl mx-auto'>© 2025 Giacomazzo Rudy, Tous droits réservés. - Développé avec <a className='font-bold underline hover:text-red-400' target='_blank' href="https://nextjs.org/">Next.js</a>.</p>
        </footer>
    )
}
